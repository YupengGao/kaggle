...
# periodic time
df_train['hour'] = (np.cos(df_train['hour']//24 * (np.pi * 2 ))+1) * 48.0
df_train['weekday'] = (df_train['weekday']%7+1)
df_train['weekday'] = (np.cos(df_train['weekday']//7 * (np.pi * 2 ))+1) * 10.5
df_train['month'] = (df_train['month']%12+1)
df_train['month'] = (np.cos( df_train['month']//12 * (np.pi * 2))+1) * 12.0
...
# periodic time
df_test['hour'] = (np.cos(df_test['hour']//24 * (np.pi * 2))+1) * 48.0
df_test['weekday'] = (df_test['weekday']%7+1)*3.0
df_test['weekday'] = (np.cos(df_test['weekday']//7 * (np.pi * 2))+1) * 10.5
df_test['month'] = (df_test['month']%12+1)
df_test['month'] = (np.cos(df_test['month']//12 * (np.pi * 2))+1) * 12.0
