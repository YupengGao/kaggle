...
def process_one_cell(df_train, df_test, grid_id, th):
    ...
    #Training Classifier
    clf = SGDClassifier(loss='modified_huber', n_iter=2, random_state=0, n_jobs=-1)  
    clf.fit(X, y)
...
if __name__ == '__main__':
    ...
    th = 50 #Threshold on place_id inside each cell. Only place_ids with at
    ...
    print ('total time for this job', end - start)